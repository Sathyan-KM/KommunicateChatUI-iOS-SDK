...
public protocol AutoSuggestionDelegate: AnyObject {
    func didMatchTwo(prefix: String, message: String)
}
...
public class KMAutoSuggestionManager: NSObject {
